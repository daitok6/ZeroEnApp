...
export const step1Schema = z.object({
  business_name: z.string().trim()
    .min(2, { error: 'errors.businessNameRequired' })
    .max(120, { error: 'errors.businessNameTooLong' }),
  industry: z.string().trim()
    .min(2, { error: 'errors.industryRequired' }),
  location: z.string().optional(),
  tagline: z.string().optional(),
  entity_name: z.string().optional(),
  timezone: z.string()
    .min(1, { error: 'errors.timezoneRequired' }),
});
...
export const step2Schema = z.object({
  ...
  primary_color: z
    .string()
    .regex(/^#[0-9A-Fa-f]{6}$/, { error: 'errors.colorFormat' })
    .optional()
    .or(z.literal('')),
  secondary_color: z
    .string()
...
export const step3Schema = z.object({
  target_audience: z.string()
    .min(10, { error: 'errors.targetAudienceTooShort' }),
  primary_cta: z.string()
    .min(2, { error: 'errors.primaryCtaRequired' }),
  key_offerings: z.array(z.string().min(1))
    .min(1, { error: 'errors.keyOfferingsMin' })
    .max(6),
});
