...
Lead-gen launch for ZeroEn's free-build program. Rebrands the existing `webmori` Coconala account to `ZeroEn / 大都`, replaces the ¥10,000 audit listing with a ¥500 consultation listing (IT・プログラミング相談カテゴリ), and seeds cross-platform distribution.
...
- **Scope honesty:** ¥500 = LP制作前のご相談・要件定義（IT・プログラミング相談カテゴリ）. Free build = 1 page, 3 sections, 1–3 day delivery, Vercel hosting, delivered after consultation to clients who proceed to subscription. Recurring ¥5,000/月 (6-month minimum) stated in 注意事項 before purchase.

## Success metrics (60-day horizon)

- 5 paid consultations (¥500 × 5)
- 3 Coconala reviews rated ≥ 4.5★
- ≥3 conversions from consultation to Stripe recurring (¥5,000/mo on zeroen.dev)

## Timeline

| Day | Action | File |
|-----|--------|------|
| 0 | Rebrand Coconala account, pause WebMori audit listing, publish new 相談 listing (IT・プログラミング相談カテゴリ, ¥500) | `webmori-takedown-checklist.md`, `coconala-profile.ja.md`, `coconala-listing.ja.md` |
